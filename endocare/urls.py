...
from .forms import UserPasswordResetForm,resetPasswordForm
...
urlpatterns = [
    ...
    path('reset/<uidb64>/<token>/',auth_views.PasswordResetConfirmView.as_view(template_name='userauth/password_reset_confirm.html',form_class=resetPasswordForm),name='password_reset_confirm'),
